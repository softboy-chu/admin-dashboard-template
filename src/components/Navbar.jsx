      ...
      <div className="px-4 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            <button onClick={onToggleSidebar} className="lg:hidden p-2 hover:bg-accent rounded-md" aria-label="Toggle menu">
              <Menu size={20} />
            </button>
            <form onSubmit={e => e.preventDefault()} className="hidden md:block">
              <div className="relative">
                ...
                <input
                  ...
                  type="search"
                  placeholder="Search..."
                  className="pl-10 pr-4 py-2 bg-background border rounded-md focus:outline-none focus:ring-2 focus:ring-ring w-64 lg:w-96 text-sm"
                />
              </div>
            </form>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button onClick={onToggleSidebar} className="hidden lg:block p-2 hover:bg-accent rounded-md" aria-label="Toggle sidebar">
              <Menu size={20} />
            </button>
        ...
        <div className="md:hidden pb-3">
          <div className="relative">
            ...
            <input
              ...
              type="search"
              placeholder="Search..."
              className="w-full pl-10 pr-4 py-2 bg-background border rounded-md focus:outline-none focus:ring-2 focus:ring-ring text-sm"
            />
          </div>
        </div>
      </div>
